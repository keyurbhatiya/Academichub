...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 18, 2025 at 08:46 AM
...
(1, 'pbkdf2_sha256$600000$jwtrTBygcnkub7XQyp82lG$allgouwb8yOIE8qkm/qHGSPuQR5tFSdv9orjmv/wnVk=', '2025-06-17 18:18:42.546364', 1, 'keyur', '', '', 'keyur@admin.com', 1, 1, '2025-06-17 17:55:23.086154'),
(2, 'pbkdf2_sha256$600000$9hWLP2R0XWC1QBioSCSaxr$KizTBK5KfOoAFFgUYVgnZ6wddxYSjH55Nfh6ju9Bmr0=', '2025-06-17 18:41:52.183739', 0, 'user1', '', '', 'user@example.com', 0, 1, '2025-06-17 18:01:56.104546');
...
INSERT INTO `core_blog` (`id`, `title`, `content`, `created_at`, `author_id`) VALUES
(1, 'Testing a blog Title', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus eum aut, illo culpa repudiandae eius voluptatum eos vitae eveniet esse quam? Sit reprehenderit sunt numquam fuga exercitationem autem obcaecati laborum!', '2025-06-17 18:06:16.525266', 2);
...
INSERT INTO `core_oldpaper` (`id`, `title`, `university`, `semester`, `file`, `uploaded_at`, `uploaded_by_id`) VALUES
(1, 'Python', 'GTU', '2', 'papers/629403_Programming_in_Python__NOV-2024.pdf', '2025-06-17 18:03:20.530856', 2);
...
INSERT INTO `core_project` (`id`, `title`, `description`, `semester`, `zip_file`, `uploaded_at`, `uploaded_by_id`) VALUES
(1, 'demo template', 'Testing', '2', 'projects/demo_tempalete.zip', '2025-06-17 18:05:00.191260', 2);
